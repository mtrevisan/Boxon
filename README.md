...
new Loader().loadCoders();
new Loader().loadCoders(CoderCustomTest.class); //this class is where the custom coder resides
new Loader().loadCoders(Collections.singletonList(new VariableLengthByteArray()));
```
